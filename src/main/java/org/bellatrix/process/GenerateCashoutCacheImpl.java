...
public class GenerateCashoutCacheImpl implements MapStore<String, GenerateCashoutDoc> {
	...
	@Override
	public GenerateCashoutDoc load(String key) {
		GenerateCashoutDoc doc = baseRepository.getPersistenceRepository()
				.retrieve(new Query(Criteria.where("_id").is(key)), GenerateCashoutDoc.class);
		return doc;
	}

	@Override
	public Map<String, GenerateCashoutDoc> loadAll(Collection<String> arg0) {
	...
	@Override
	public void store(String arg0, GenerateCashoutDoc doc) {
	...
	@Override
	public void storeAll(Map<String, GenerateCashoutDoc> arg0) {
		// TODO Auto-generated method stub
